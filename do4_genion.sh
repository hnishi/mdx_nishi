#!/bin/bash
grompp -f IONS.mdp -c solv.gro -p prm.top -o ions_na.tpr
genion -s ions_na.tpr -o solv_na.gro -p prm.top -pname NA -nname CL -neutral -conc 0.15 <<< "SOL"
grompp -f IONS.mdp -c solv_na.gro -p prm.top -o ions_na_mg.tpr
genion -s ions_na_mg.tpr -o solv_na_mg.gro -p prm.top -pname MG -nname CL -neutral -conc 0.01 <<< "SOL"
...
#genion -s ions_mg.tpr -o solv_mg.gro -p prm.top -pname MG -pq 2 -np 16 <<< "SOL"
