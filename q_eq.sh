...
grompp -v -f EQ1.mdp -c min3.gro -p prm.top -o eq1   
...
grompp -v -f EQ3.mdp -c eq2.gro -p prm.top -t eq2.cpt -o eq3    
mpijob /lfs/mtateno/chika/program/all/gromacsMPI/bin/mdrun_mpi -v -deffnm eq3
